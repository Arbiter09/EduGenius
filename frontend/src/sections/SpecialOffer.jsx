  ...
  return (
    ...
    <section className="flex justify-wrap items-center max-xl:flex-col-reverse gap-10 max-container ">
      ...
      <div className="flex flex-1 flex-col "  style={{ tmarginRight: 'auto' }}>
        ...
        Welcome to EduGenius, your personalized companion on the journey of academic excellence and knowledge enrichment.
        </p>
        <p className="mt-6 lg:max-w-lg info-text" style={{color: "lightgray"}}>
        At EduGenius, we understand that every learner is unique, with varying speeds and capabilities to grasp different subjects. Our cutting-edge artificial intelligence algorithms are designed to adapt and cater to your individual learning style, ensuring a tailored educational experience. We prioritize not just academic achievement but overall comprehension, fostering a learning environment that aligns with your pace and capacity for understanding.
        </p>
